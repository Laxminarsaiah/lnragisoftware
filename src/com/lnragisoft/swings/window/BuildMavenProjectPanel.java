...
public class BuildMavenProjectPanel extends WebPanel {
	...
	String mavenBuildTitleTxt = "<html><font>Select POM.XML Location:</font></html>";
...
//		northPanel.add(addJProgressPanel(true), BorderLayout.EAST);
	...
	class TextAreaThread extends Thread {
		...
		public void run() {
			northPanel.add(addJProgressPanel(true), BorderLayout.EAST);
			AlertsManager.info("Building maven project...");
			textArea.setText("");
			statusBarLabel.setIcon(Icons.loader);
			buildStatus = false;
